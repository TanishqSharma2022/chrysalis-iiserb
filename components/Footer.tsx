...
export default function Footer() {
  ...
  return (
    <motion.div
      className="w-full relative  flex flex-col gap-12 p-12 md:p-24 items-center justify-center bg-zinc-900"

    >
       <motion.div
      className='rounded-full h-48 w-48 blur-[100px] bg-gradient-to-tr from-sky-200 to-blue-300  absolute   top-0 left-0 '
    />
      <div className="flex  md:flex-row flex-col items-center  gap-12">
        <div className="w-full">
          ...
          <p className="mt-4 text-lg leading-8 text-white">
            You can subscribe to our newsletter to get the latest updates and
            blogs straight into your mail.
          </p>
          <div className="mt-6 flex max-w-md gap-x-4">
            ...
            <input
              ...
              type="email"
              required
              className=" min-w-0 flex-auto rounded-md border-0 bg-white/5 px-3.5 py-2 text-white shadow-lg ring-1 ring-inset ring-white/10 focus:ring-2 focus:ring-inset focus:ring-indigo-500 sm:text-sm sm:leading-6"
              placeholder="Enter your email"
            />
            <button
              type="submit"
              className="flex-none rounded-md bg-indigo-500 px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-indigo-400 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 bg-gradient-to-b from-sky-500 to-blue-600"
            >
              Subscribe
            </button>
          </div>
        ...
        <div className=" w-full  text-white flex flex-col">
          <div className="w-full text-4xl font-bold">
            <h1 className="w-full font-bold">Contribute to us.</h1>
          </div>
          <div className="flex mt-4 flex-col gap-12  md:justify-between">
            <p className="w-full md:w-2/3 text-gray-400">
              You can contribute to this project. Contact us through email or
              whatsapp.
            </p>
            <div className="w-44 pt-6 md:pt-0">
              <a className="bg-blue-500 hover:bg-blue-600 justify-center text-center rounded-lg shadow px-10 py-3 flex items-center">
                Contact Us
              </a>
            </div>
          </div>
