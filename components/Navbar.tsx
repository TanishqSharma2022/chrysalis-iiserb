...
export default function Navbar({posts}) {
  ...
  return (
    <nav className='bg-white  z-[50] w-full'>

    <header className="px-2 md:px-4 mb-10 mt-6 md:mt-4 flex items-center md:mb-4 flex-row justify-between text-pretty  z-[50] bg-blue header-nav">
      ...
      <div className="flex gap-4 md:gap-12 overflow-x-hidden z-[60]">
        <Example posts={posts} />
        <HamburgerMenu />
      </div>
