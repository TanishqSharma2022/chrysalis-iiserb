            ...
            <div className="embla__slide max-h-[80vh]" key={index}>
              ...
              <div className="embla__parallax">
                ...
                >
                    ...
                    <div className="transition-all Carousel_Container  hover:bg-black/60 bg-gradient-to-t inset-0 from-black via-black/50 to-transparent backdrop-blur-12 w-full   absolute bottom-0 text-white ">
