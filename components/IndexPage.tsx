...
export default function IndexPage(props: IndexPageProps) {
  ...
  return (
    <div className="overflow-x-hidden" onMouseMove={handleMouseMove}>
      ...
      {/* Editions Sections */}
      <Layout preview={preview} loading={loading}>
        {/* <div className="w-full bg-gradient-to-br from-sky-300 to-blue-700 bg-cover min-h-[15vh] lg:h-[50vh] bg-fixed"></div> */}
        <div className="py-12 md:px-12   bg-gradient-to-br from-sky-300 to-blue-700 ">
          <div className=" shadow-lg  py-12 p-2  text-center  bg-white rounded-2xl ">
            <h1 className=" font-bold  font-sfheavy mb-4 text-4xl md:text-6xl bg-gradient-to-br from-sky-500 to-blue-800 bg-clip-text text-transparent">
              Our Editions
            </h1>
        ...
        <div className="w-full md:px-24 md:py-12 px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mt-12">
            <iframe
              ...
              src="https://www.youtube.com/embed/90Aiidf2i-U?si=LBADkp_M4UKjugN1"
            ...
            <iframe
              className="rounded-xl w-full aspect-[16/9]"
              src="https://www.youtube.com/embed/JYnRkJZaG9c?si=kCJHrk8VkGvFKn6R"
              title="YouTube video player"
              allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
              allowFullScreen
            ></iframe>
            <iframe
              className="rounded-xl w-full aspect-[16/9]"
              src="https://www.youtube.com/embed/8nxmBWHcdwo?si=XJSSA6tiqpOHmi-k"
              title="YouTube video player"
              allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
              allowFullScreen
            ></iframe>
            <iframe
              className="rounded-xl w-full aspect-[16/9]"
              src="https://www.youtube.com/embed/AmkbFBczEAY?si=iEYZUCka5q5hvLsz"
              title="YouTube video player"
              allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
              allowFullScreen
            ></iframe>
            <iframe
              className="rounded-xl w-full aspect-[16/9]"
              src="https://www.youtube.com/embed/ZY0Hi6U7nZI?si=VF_tm8ETz2xHCPIA"
              title="YouTube video player"
              allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
              allowFullScreen
            ></iframe>
            <iframe
              className="rounded-xl w-full aspect-[16/9]"
              src="https://www.youtube.com/embed/eZi07kYBD1k?si=hLvWkw4OdGclqmPa"
              title="YouTube video player"
              allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
              allowFullScreen
            ></iframe>
          ...
          {/* <div className='w-full flex items-center justify-center mt-4'> */}
            <Link href={'https://www.youtube.com/@chrysalisiiserb8439/featured'} target='_blank'>
              <p className="border rounded-full px-4 py-2 text-xl mx-auto w-fit mt-6 transition-all duration-1000 hover:border-black cursor-pointer font-sfbold shadow-blue-950 shadow-sm text-transparent bg-gradient-to-t from-sky-950 to-blue-950 bg-clip-text">Watch More</p></Link>
          {/* </div> */}
        </div>
      </Layout>
